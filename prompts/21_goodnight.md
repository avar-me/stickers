...
**Известное ограничение:** после двух попыток генератор стабильно печатает
"Сордольикӏ!" (мягкий знак ь вместо твёрдого ъ) и не поддаётся исправлению даже
с явным указанием буквы. Решено принять текущий вариант как есть — см.
