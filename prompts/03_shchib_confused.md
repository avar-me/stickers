...
Confused puzzled expression, one eyebrow raised higher than the other, eyes slightly asymmetric, one gloved hand scratching the top of the head, the other hand open at the side, head tilted, small question-mark-like pose (do not literally add a ? symbol, express confusion through pose).
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Щиб?"
```

**Caption overlay (текст на стикере):** "Щиб?"
