...
Friendly open smile, eyebrows raised in welcome, one gloved hand raised high waving, the other hand resting on hip, standing pose, slight tilt to the side as if greeting someone.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Салам!"
```

**Caption overlay (текст на стикере):** "Салам!"
