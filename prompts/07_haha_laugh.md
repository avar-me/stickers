...
Big laughing expression, eyes squeezed into happy curved lines, eyebrows raised high, wide open mouth laughing, both gloved hands raised up in the air with joy, body leaning slightly back as if laughing hard, small motion lines optional near the head.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Хаха!"
```

**Caption overlay (текст на стикере):** "Хаха!"
