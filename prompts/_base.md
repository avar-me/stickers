# Базовый блок промпта (вставляется в начало каждого промпта)
...
Below: emotion / pose / props / caption specific to this sticker only — everything else
must stay identical to the base description above.
