...
Focused curious expression, eyebrows slightly furrowed in concentration, one eye visually enlarged behind a magnifying glass prop held in one gloved hand, the other hand on hip, standing pose leaning slightly forward as if searching.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Ищу слово..."
```

**Caption overlay (текст на стикере):** "Ищу слово..."
