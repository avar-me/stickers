# Стикер 22 — "Нух битӏаги!"
_(Счастливого пути!)_
...
The character rides on top of a small cartoon airplane (white body, blue accents, simple flat cute style matching the sticker), one gloved hand waving cheerfully, the other hand resting on the plane, big happy smile, small clouds and motion swoosh lines around the plane to suggest flight.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Нух битӏаги!"
```

**Caption overlay (текст на стикере):** "Нух битӏаги!"
