...
Warm inviting expression, eyebrows relaxed and friendly, gentle smile, one gloved hand holding a small coffee/tea cup prop offered forward, the other hand open at the side, standing pose leaning slightly forward offering the cup.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Чай?"
```

**Caption overlay (текст на стикере):** "Чай?"
