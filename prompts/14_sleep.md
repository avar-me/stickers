...
- Reproduce the caption text EXACTLY character-for-character as given below, including
  every diacritic and special Avar letter (е.g. Ӏ/ӏ "palochka", Ӏ combined with other
  letters, ь, Ӏ). Do not "correct", simplify, transliterate, or substitute any letter
  (do not replace ӏ/Ӏ with 1, do not drop ь, do not swap ы/и or к/кь/кӏ). Copy the exact
...
Sleepy tired expression, eyebrows low and relaxed, eyes half-closed or closed with small curved lines, small 'zzz' props floating near the head (optional), one gloved hand covering a yawning mouth, the other hand hanging low, body slightly slouched as if about to lie down.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Кьижизе бокьун буго."
```

**Caption overlay (текст на стикере):** "Кьижизе бокьун буго."
