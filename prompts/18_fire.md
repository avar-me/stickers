...
Excited impressed expression, eyebrows raised high, wide amazed smile, one gloved hand pointing at a small flat flame/fire icon prop next to the character, the other hand on hip, standing pose leaning slightly forward with enthusiasm.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Бомба!"
```

**Caption overlay (текст на стикере):** "Бомба!"
