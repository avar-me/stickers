...
Firm disapproving expression, eyebrows sharply angled down in an X-like frown, mouth a short flat line, both gloved hands crossed in front forming an X gesture (like blocking), standing pose leaning slightly back.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "ГьечӀо!"
```

**Caption overlay (текст на стикере):** "ГьечӀо!"
