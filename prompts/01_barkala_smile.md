...
Happy warm smile, eyebrows raised softly in a friendly arc, eyes shaped as soft happy curves, one gloved hand placed over the chest (over the book cover) in a thankful gesture, the other hand slightly open to the side, standing pose, slight forward lean of gratitude.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Баркала!"
```

**Caption overlay (текст на стикере):** "Баркала!"
