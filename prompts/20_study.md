...
Studious motivated expression, eyebrows focused and determined, small confident smile, one gloved hand holding a pencil prop as if writing/pointing at notes, a small stack of books prop beside the character (optional), standing pose leaning slightly forward with energy.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "ЦӀализе!"
```

**Caption overlay (текст на стикере):** "ЦӀализе!"
