...
Sad expression, eyebrows angled up and inward (worried sad shape), eyes slightly downturned with a single small teardrop, mouth a small downward curve, both gloved hands hanging low, shoulders (top corners of the book) slumped, standing pose leaning slightly forward.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Вай..."
```

**Caption overlay (текст на стикере):** "Вай..."
