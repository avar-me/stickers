...
Loving warm expression, eyebrows soft and raised gently, eyes shaped as soft happy curves with a light blush accent (#E8544E) on the pages/cheeks, both gloved hands forming a heart shape together in front of the chest, standing pose.
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Бокьула."
```

**Caption overlay (текст на стикере):** "Бокьула."
