...
Proud determined expression, eyebrows strong and confident, big smile, both gloved hands flexed in a double-bicep strong-man pose, standing pose with feet firmly planted, slight motion/sparkle accents near the hands (optional).
Caption text rendered on the sticker (dark navy, bold, rounded font, below the character): "Бажарана!"
```

**Caption overlay (текст на стикере):** "Бажарана!"
